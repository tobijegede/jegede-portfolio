...
|11. Do you have any final thoughts or suggestions that weren’t already covered in the previous questions? | could inlcude in the call to action an actual list of nonprofits to donate to and how your donation would be used for the non-profits vs how it could be used for the university’s purposes  | Fix the capitalization in the call to action section (make sure that they all do or do not have periods at the end)
     | Show  income in a neighboring town town — and some additional articles that could be useful |
